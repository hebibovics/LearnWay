...
const LoginPage = () => {
  ...
  return (
    <FormContainer>
      <h1 className="mt-5">Welcome to LearnWay!</h1>
      <h4>Sign in to explore our courses and start learning</h4>
      <Form onSubmit={submitHandler}>
        <Form.Group className="my-3" controlId="username">
          <Form.Label className="mt-5">User Name</Form.Label>
          <Form.Control
            type="text"
      ...
      {loginReducer.loading ? (
        ...
        <Row className="py-3">
          <Col>
            New User?{" "}
            <Link to="/register" style={{ color: "rgb(33, 182, 168)" }}>
              <b>Register</b>
            </Link>
          </Col>
        </Row>
